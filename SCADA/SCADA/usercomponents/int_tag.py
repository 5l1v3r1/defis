...
"""
Компонент целочисленного тега SCADA системы.
"""
...
# --- Спецификация ---
SPC_IC_INT_SCADA_TAG = {'min_value': None,
                        'max_value': None,
                        'scale_value': None,
                        'offset_value': None,
                        'units': '',
...
#   Имя класса
ic_class_name = 'icIntSCADATag'

#   Спецификация на ресурсное описание класса
ic_class_spc = {'type': 'IntSCADATag',
                'name': 'default',
                'child': [],
                'activate': True,
                '_uuid': None,
...
class icIntSCADATag(icwidget.icSimple, scada_tag.icSCADATagProto):
    """
    Компонент целочисленного тега SCADA системы.
