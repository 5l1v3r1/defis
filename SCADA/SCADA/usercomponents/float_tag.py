...
# --- Спецификация ---
SPC_IC_FLOAT_SCADA_TAG = {'min_value': None,
                          'max_value': None,
                          'scale_value': None,
                          'offset_value': None,
                          'units': '',
...
#   Имя класса
ic_class_name = 'icFloatSCADATag'

#   Спецификация на ресурсное описание класса
ic_class_spc = {'type': 'FloatSCADATag',
                'name': 'default',
                'child': [],
                'activate': True,
                '_uuid': None,
                ...
                '__attr_types__': {icDefInf.EDT_TEXTFIELD: ['description', '_uuid', 'units'],
                                   ...
                                   icDefInf.EDT_NUMBER: ['min_value', 'max_value',
                                                         'scale_value', 'offset_value'],
                                   },
                '__parent__': SPC_IC_FLOAT_SCADA_TAG,
                }

#   Имя иконки класса, которые располагаются в директории
#   ic/components/user/images
ic_class_pic = ic_bmp.createLibraryBitmap('tag_purple.png')
ic_class_pic2 = ic_bmp.createLibraryBitmap('tag_purple.png')
...
class icFloatSCADATag(icwidget.icSimple, scada_tag.icSCADATagProto):
    """
    Компонент вещественного тега SCADA системы.
