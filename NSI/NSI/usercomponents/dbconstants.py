...
# -----------------------------------------------------------------------------
# Name:       dbconstants.py
# Purpose:    Константы, хранящиеся в БД
#
# Author:     <Колчанов А.В.>
#
# Created:     class:Thu Mar 16 14:00:39 2006
# RCS-ID:      
# Copyright:   (c) 2006 Infocentre
# Licence:     $licence:<your licence>$
# -----------------------------------------------------------------------------
"""
Класс пользовательского компонента КОНСТАНТЫ.
...
import NSI.nsi_sys.icdbconstants as parentModule
