...
"""
Класс пользовательского компонента ДОКУМЕНТ.
...
class icDocument(icwidget.icSimple, parentModule.icDocumentProto):
    """
    Документ прикладной системы.
    В общем виде документ это объект состояния,
    в котором определяются операции изменения состояния.
    ...
    def __init__(self, parent, id=-1, component=None, logType=0, evalSpace=None,
        ...
        parentModule.icDocumentProto.__init__(self, parent)
